...
locals {
  ...
  #     SecretValue = {"username": "my-user", "password": "my-pass"}
  #
  # then the secret "credentials:username" would refer to "my-user"
  # and "credentials:password" would refer to "my-pass".
  #
