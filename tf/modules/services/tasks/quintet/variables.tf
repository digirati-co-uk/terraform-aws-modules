...
variable "docker_image_sidecar_4" {
  description = "URL of Docker image to use for sidecar 4"
}
...
variable "container_name_sidecar_4" {
  description = "Name of the sidecar 4 container"
  default     = ""
}
...
variable "cpu_reservation_sidecar_4" {
  description = "Amount of CPU to reserve for task in sidecar 4 container"
  default     = 0
}
...
variable "memory_reservation_sidecar_4" {
  description = "Amount of memory to reserve for task in sidecar 4 container"
  default     = 128
}
...
variable "environment_variables_sidecar_4" {
  description = "Map of environment variables for sidecar 4 container"
  type        = map
  default     = {}
}
...
variable "secret_environment_variables_sidecar_4" {
  description = "Map of environment variables for sidecar 4 container"
  type        = map
  default     = {}
}
...
variable "command_sidecar_4" {
  description = "Override for sidecar 4 container command"
  type        = list
  default     = []
}
...
variable "mount_points_sidecar_4" {
  description = "List of sidecar 4 container mount points"
  type        = list
  default     = []
}
...
variable "volumes_from_sidecar_4" {
  description = "List of sidecar 4 container volumesFrom entries"
  type        = list
  default     = []
}
...
variable "links_sidecar_4" {
  description = "List of links for sidecar 4 container"
  type        = list
  default     = []
}
...
variable "user_sidecar_4" {
  description = "User to set for sidecar 4 container"
  default     = ""
}
